...
| -------------------- | --------------------------- | -------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------- |
| Chat & collaboration | Element ft. Nordeck widgets | AGPL-3.0-or-later (Element Web), AGPL-3.0-only (Synapse), Apache-2.0 (Nordeck widgets) | [1.12.18](https://github.com/element-hq/element-web/releases/tag/v1.12.18)                    | [For the most recent release](https://element.io/user-guide)                                                                          |
...
| Diagram editor       | CryptPad ft. diagrams.net   | AGPL-3.0-only                                                                          | [2026.5.1](https://github.com/cryptpad/cryptpad/releases/tag/2026.5.1)                        | [For the most recent release](https://docs.cryptpad.org/en/)                                                                          |
| File management      | Nextcloud                   | AGPL-3.0-or-later                                                                      | [33.0.9](https://nextcloud.com/de/changelog/#33-0-9)                                          | [Nextcloud 33](https://docs.nextcloud.com/)                                                                                           |
| Groupware            | OX App Suite                | GPL-2.0-only (backend), AGPL-3.0-or-later (frontend)                                   | [8.51](https://documentation.open-xchange.com/appsuite/releases/8.51/)                        | Online documentation available from within the installed application; [Additional resources](https://documentation.open-xchange.com/) |
...
| Portal & IAM         | Nubus                       | AGPL-3.0-or-later                                                                      | [1.21.0](https://docs.software-univention.de/nubus-kubernetes-release-notes/1.x/en/1.21.html) | [Univention's documentation website](https://docs.software-univention.de/n/en/nubus.html)                                             |
| Project management   | OpenProject                 | GPL-3.0-only                                                                           | [17.7.2](https://www.openproject.org/docs/release-notes/17-7-2/)                              | [For the most recent release](https://www.openproject.org/docs/user-guide/)                                                           |
| Videoconferencing    | Jitsi                       | Apache-2.0                                                                             | [2.0.11146](https://github.com/jitsi/jitsi-meet/releases/tag/stable%2Fjitsi-meet_11146)       | [For the most recent  release](https://jitsi.github.io/handbook/docs/category/user-guide/)                                            |
| Weboffice            | Collabora                   | MPL-2.0                                                                                | [26.04.2](https://www.collaboraoffice.com/code-26-04-release-notes/)                          | Online documentation available from within the installed application; [Additional resources](https://sdk.collaboraonline.com/)        |
