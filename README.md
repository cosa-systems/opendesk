...
| Groupware            | OX App Suite                | GPL-2.0-only (backend), AGPL-3.0-or-later (frontend)                                   | [8.48](https://documentation.open-xchange.com/appsuite/releases/8.48/)                        | Online documentation available from within the installed application; [Additional resources](https://documentation.open-xchange.com/) |
| Knowledge management | XWiki                       | LGPL-2.1-or-later                                                                      | [17.10.7](https://www.xwiki.org/xwiki/bin/view/ReleaseNotes/Data/XWiki/17.10.7/)              | [For the most recent release](https://www.xwiki.org/xwiki/bin/view/Documentation)                                                     |
...
| Project management   | OpenProject                 | GPL-3.0-only                                                                           | [17.4.1](https://www.openproject.org/docs/release-notes/17-4-1/)                              | [For the most recent release](https://www.openproject.org/docs/user-guide/)                                                           |
